...
function About({ onNavigate }) {
  const journey = [
  { year: "Childhood", title: "Raised by a problem solver", body: "My dad taught me to work smarter, not harder — and the importance of design for real people in real contexts.\nWhen our green garden tools disappeared into the grass, my dad tied bright ribbons to them. When my hair got caught in the exposed wheels of a car creeper, he bought one designed with covered wheels instead. Clearly they hadn’t anticipated a user with long hair.\n\nI’ve been looking for better ways to do things ever since.", image: "high school", imgTitle: "First portfolio site", imgCaption: "The Tumblr theme that started it all — built in a dorm room." },
